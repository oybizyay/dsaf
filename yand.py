...
def yand ():
    ...
    book_new = openpyxl.open("ТК/Отчет Яндекс Доставка НП от 03.07.2023.xlsx")
    ...
    book_new.save("res/Отчет Яндекс Доставка НП от %s %s.xlsx" % (yesterday, round(sm,2)))
    book_new.close()